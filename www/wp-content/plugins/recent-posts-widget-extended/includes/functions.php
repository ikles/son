		...
		$html = '<div class="w75">';
			...
			$html .= '';
				...
				while ( $posts->have_posts() ) : $posts->the_post();
					...
					$html .= '<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 rpwe-clearfix">';

						if ( $args['thumb'] ) :

							// Check if post has post thumbnail.
							if ( has_post_thumbnail() ) :
								$html .= '<a class="img_a" href="' . esc_url( get_permalink() ) . '"  rel="bookmark">';
									if ( $image ) :
						...
						$html .= '<h3 class="rpwe-title"><a href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'recent-posts-widget-extended' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark">' . esc_attr( get_the_title() );
						...
						if ( $args['date'] ) :
							...
							$html .= '<span class="date1">' . esc_html( $date ) . '</span>';
